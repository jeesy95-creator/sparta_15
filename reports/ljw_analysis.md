...
3) Normal Day -> 중앙값이 가장 아래쪽 (약 -2 근처), 분산도 작음
        : Normal Day는 개인 평균 활동 수준을 의미하기보다는, 
          4개의 DayType 기준에 해당하지 않는 잔여 범주로 정의되었다. 
          따라서 사용자별 z-score 기준에서 Normal Day가 평균 이하로 분포하는 것은 분류 오류라기보단 Active Day 기준이 상대적으로 넓게 설정된 결과로 해석됨
